    ...
    <Wrapper>
      ...
      <ContentContainer>
        <Article>
          ...
          <P>
            ㈜브이엘피엠 (이하 ”회사”)는 개인정보를 보호하며, 『정보통신망 이용촉진 및 정보보호에
            관한 법률』,『개인정보보호법』등에 관련 법령을 준수하며 다음과 같이 개인정보처리방침을
            공개 합니다.
          </P>
        </Article>
        <Article>
        ...
        <Article>
          ...
          <OL>
            <P>
              “회사”는 서비스 제공에 필요한 최소한의 개인정보를 수집하고 있습니다. 서비스 제공에
              필요한 최소한의 정보 외의 정보는 동의하지 않을 수 있습니다. “회사” 가 수집하는
              개인정보 항목과 방법은 다음과 같습니다.
            </P>
            <li>
              대상 수집 항목 방법
              <P>
                ...
                이벤트 응모, 개별 계약서 파트너스 성명, 생년월일, 성별, 아이디, 휴대전화번호,
                DI(Duplication information), E-mail, 매장정보
              </P>
              <P>
                ※ 회사의 서비스 이용 과정에서 서비스 이용기록, 방문기록, 불량 이용기록, IP주소,
                쿠키, MAC주소, 모바일 기기정보(앱 버전, OS 버전), ADID/IDFA(광고식별자) 등의 정보가
        ...
        <Article>
          ...
          <OL>
            ...
            <li>
              <P>(1) 휴면 회원 : “발품노노” 서비스를 1년 이상 이용하지 않은 회원</P>
              ...
              <P>
                (4) 휴면 회원이 “발품노노” 서비스에 로그인할 경우 휴면계정은 자동으로 일반 회원
                계정으로 복구됩니다.
              </P>
            </li>
          </OL>
          ...
          <OL>
            <P>
              ...
              <li>
                ...
                <P>
                  “발품노노”에 공식 등록한 파트너스 상담 신청 이름, 휴대전화번호 및 기타
                  서비스제공에 필요한 상담정보 개인정보 이용목적 달성 시까지.
                </P>
                <P>단, 관계법령에 의해 보존할 필요성이 있는 경우 그 시점까지 보존 후 파기</P>
              </li>
            </P>
          </OL>
        </Article>
