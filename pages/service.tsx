    ...
    <Wrapper>
      ...
      <ContentContainer>
        ...
        <Article>
          <H2>제1조 (목적)</H2>
          <P>
            본 약관은 주식회사 브이엘피엠(이하 “회사”)가 제공하는 인터넷 서비스 및 기타 모바일
            어플리케이션(이하 “어플”)과 관련하여 “회사”와 “이용자” 및 “파트너스”와의 권리, 의무 및
        ...
        <Article>
          ...
          <OL>
            <li>
              <P>
                1. “발품노노”란 ”회사”가 운영하는 어플 및 웹사이트를 포함한 “서비스” 관련 제반
                시스템을 의미합니다.
              </P>
              <P>
                2. “서비스”란 “발품노노”의 ”회원”이 제품 정보 및 가격 정보를 알아보고 상담신청 및
                서비스의 이행을 의뢰하는 일련의 과정과 “파트너스”가 필요로 하는 상담 서비스의 이행을
                제공하는 과정을 말하며 구현되는 단말기 (휴대형 단말기, PC 등의 각종 유무선 장치를
                포함)와 상관없이 이용할 수 있는 제반 서비스 모두를 의미합니다.
              </P>
              <P>
                3. “이용자”란 “발품노노”에 접속하여 “회사”가 제공하는 서비스를 이용하는 자를
              ...
              <P>
                6. “파트너스”란 “발품노노”에 접속하여 “회사”가 제공하는 서비스를 활용하는
                “인증등록회원”을 말합니다.
              </P>
              <P>
        ...
        <Article>
          ...
          <OL>
            <li>
              <P>
                1. “회사”는 “이용자”가 본 약관의 내용을 쉽게 알 수 있도록 “회사”가 제공하는 플랫폼을
                통해 공지합니다. 본 약관에 동의한 “회원” 모두에게 그 효력이 발생합니다.
              </P>
              <P>
          ...
          <OL>
            <li>
              ...
              <P>
                ...
                “회사” 또는 “파트너스”에게 피해가 발생할 경우, 그에 대한 모든 책임은 “회원”에게
                귀속됩니다.
              </P>
              <P>
                3. “회원”은 “파트너스”가 제공하는 견적 정보의 조건과 내용을 정확하게 확인해야 하며,
                견적 정보의 조건과 내용을 확인하지 않아서 발생한 모든 손해는 “회원”에게 있습니다.
              </P>
              <P>4. “회원”은 다음 각 호의 사유에 해당하는 행위를 하여서는 안 됩니다.</P>
              <OL2>
                <li>
                  <P2>4-1) “회사”의 정보를 부정하게 취득하는 행위</P2>
                  <P2>
                    4-2) 비방 또는 악의적인 목적을 가지고 욕설 등 인격에 대한 모욕을 하는 경우
                  </P2>
                  <P2>4-3) 사실에 근거하지 않고 부당한 보상을 요구하는 경우</P2>
                  <P2>4-4) “회원”의 개인 정보를 허위 또는 타인의 것으로 등록하는 행위</P2>
                  <P2>
                    4-5) “회사” 홈페이지 또는 어플 해킹 또는 기타 유사한 프로그램 등을 이용하여
                    정상적인 운영을 어렵게 하는 경우
                  </P2>
                  <P2>4-6) “파트너스” 또는 “회사”와 상담 시 폭언, 욕설, 성희롱 등의 행위</P2>
                  <P2>4-7) 기타 “회사”의 영업을 부당한 방법으로 방해하는 행위</P2>
                  <P2>4-8) 기타 관련 법령에 위반되는 행위</P2>
                </li>
              </OL2>
              <P>
                5. 제4항에 해당하는 행위를 한 소비자가 있을 경우 “회사”는 다음 각호에서 정한 바에
                따라 회원자격을 제한 및 정지, 상실 시킬 수 있습니다.
              </P>
              <OL2>
                <li>
                  <P2>
                    5-1) “회사”는 회원 자격을 제한 또는 정지시킨 후, 동일한 행위가 2회 이상
                    반복되거나 14일 이내에 그 사유가 시정되지 아니하는 경우 회사는 회원자격을 상실
                    시킬 수 있습니다.
                  </P2>
                  <P2>
                    5-2) “회사”가 회원 자격을 상실시키는 경우에는 즉시 회원등록 기록을 말소하고
                    회원에게 이를 통지하며, 회원등록 말소 전에 소명할 기회를 부여합니다.
                  </P2>
                </li>
              </OL2>
              <P>6. 제4항에 해당할 경우 “회사”는 “회원”에게 손해배상을 청구할 수 있습니다.</P>
            </li>
          </OL>
        </Article>
        <Article>
          ...
          <OL>
            <li>
              <P>
                1. “회사”는 “회원”과 “파트너스” 간 재화 또는 용역 등의 거래를 중개하는 플랫폼
                서비스만을 제공할 뿐, 재화 등을 판매하는 당사자가 아니며, 재화 또는 용역 등에 대한
                정보 및 이행여부 등에 대한 책임은 “회원”과 “파트너스”에게 있습니다. 다만, “회사”는
                신의성실의 원칙에 따라 “회원”과 “파트너스” 간의 분쟁해결을 위해 중재, 조정하는
                역할을 할 수 있습니다.
              </P>
              <P>
              ...
              <P>
                3. “회사”는 “파트너스” 혹은 “회원”이 작성 및 등록 등의 방법으로 “서비스”에 게재된
                정보, 자료, 사실의 신뢰도, 정확성 등에 대해서는 보증을 하지 않으며, 이로 인해 발생한
                “파트너스” 혹은 “회원”의 물리적, 신체적, 정신적, 금전적 등 손해 일체에 대해서는
                “회사”가 해당 정보의 허위성을 명백히 인지하였다는 특별한 사정이 없는 한, 어떠한
                도덕적, 법적 책임이나 의무도 부담하지 않습니다.
              </P>
              <P>
                4. “회원”이 “발품노노”에서 추천한 ”파트너스”를 이용할지 여부는 전적으로 “회원”
                스스로의 판단에 따라 결정하는 것으로 “회사”는 회원이 해당 “파트너스”를 이용하여
                발생하는 직,간접적 문제에 대한 책임을 지지 않습니다.
              </P>
              <P>
                5. “회사”는 “파트너스” 혹은 “회원”이 “서비스”를 이용하여 기대하는 이익을 얻지
                못하거나 상실한 것에 대하여 책임을 지지 않으며, “파트너스” 혹은 “회원”상호간 및
                “파트너스” 혹은 “회원”과 제3자 상호 간에 “서비스”를 매개로 발생한 분쟁에 대해 개입할
                의무가 없고, 이에 따른 손해를 배상 및 보상하는 어떠한 도덕적, 법적 책임이나 의무도
                부담하지 아니합니다.
              </P>
              <P>
              ...
              <OL2>
                <li>
                  <P2>7-1) “회원”과 “파트너스”간의 거래 분쟁 및 대금의 문제가 발생한 경우</P2>
                  <P2>
                  ...
                  <P2>
                    7-6) “회사”의 고의 또는 과실과 무관하게 “파트너스”가 계약 이행 과정 혹은 완료
                    이후에 “회원” 또는 제3자의 개인정보가 침해된 경우
                  </P2>
                  <P2>
                    7-7) 기타 “이용자”가 발생한 손해중 “회사”의 고의 또는 중과실로 발생한 손해가
                    아닌 경우
                  </P2>
                </li>
              </OL2>
          ...
          <OL>
            <li>
              ...
              <P>
                ...
                플랫폼에 게시합니다. 다만, 개인 정보 처리 방침의 구체적 내용은 연결 화면을 통하여 볼
                수 있습니다.
              </P>
              <P>
              ...
              <OL2>
                <li>
                  ...
                  <P2>
                    5-3) “서비스”이용 시 “파트너스”에게 용역에 필요한 최소한의 “회원”의 정보(연락처
                    등)를 알려주는 경우
                  </P2>
                  <P2>5-4) “회원”과 “파트너스”의 분쟁 해결을 위해 필요한 경우</P2>
                  <P2>5-5) 기타 법률에 의해 요구되는 경우</P2>
                </li>
              </OL2>
            </li>
          </OL>
        ...
        <Article>
          <H2>제13조 (“발품노노” 서비스 이용제한)</H2>
          <P>
            “발품노노” 서비스를 이용하는 “회원”은 별도로 동의한 “회사” 운영규정에 해당하는 과실
            행위를 하여서는 안되며, 이에 해당하는 문제 발생시 “회사”의 운영규정에 따라 규정 처리 및
            경우에 따라 “회사”에 의해 “회사” 또는 ”파트너스”에게 피해보상 절차가 진행될 수 있습니다.
          </P>
        </Article>
        <Article>
          <H2>제14조 (“게시물”)</H2>
          <OL>
            <li>
              ...
              <P>
                ...
                명예훼손 등 “파트너스”의 권리가 침해된 경우 그 침해를 받은 자는 해당 정보를 처리한
                정보통신서비스 제공자에게 침해사실을 소명하여 그 정보의 삭제 또는 반박내용의 게재 및
                삭제를 요청할 수 있습니다. 이 경우 회사는 해당 게시물 등의 권리 침해여부를 판단할 수
                없거나 당사자 간의 다툼이 예상되는 경우 해당 게시물 등에 대한 접근을 임시적으로
                차단하는 조치(이하 “임시조치”라 합니다)를 최장 30일까지 취할 수 있으며 임시조치한
                날로부터 30일이 도래하는 시점에 임시조치를 해제합니다.
              </P>
              <P>
              ...
              <OL>
                <li>
                  ...
                  <P>
                    3-9) 정당한 사유 없이 “회사” 또는 “파트너스”의 영업을 방해하는 내용을 기재하는
                    경우
                  </P>
                  <P>
                    3-10) “파트너스” 홍보 목적으로 “파트너스”가 직접 또는 제3자를 통하여 부당한
                    방법으로 허위 또는 과장된 게시글을 게재하는 경우
                  </P>
                  <P>
                    3-11) 부당한 방법으로 리뷰 권한을 획득하여 “이용자” 또는 제3자의 계정을 이용하여
                    게시글을 게시하는 경우
                  </P>
                  <P>3-12) 의미 없는 문자 및 부호에 해당하는 경우</P>
                  <P>3-13) 제3자 등으로부터 권리침해신고가 접수된 경우</P>
                  <P>
                    3-14) “서비스” 명칭 또는 임직원이나 “서비스”와 관련한 운영진을 사칭하여
                    “파트너스”를 속이거나 이득을 취하는 등 피해와 혼란을 주는 행위
                  </P>
                  <P>3-15) 관계법령에 위반된다고 판단되는 경우</P>
                  <P>
                    3-16) “회사”의 서비스 약관, 운영정책 등 위반행위를 할 우려가 있거나 위반행위를
                    한 경우
                  </P>
                  <P>
                    3-17) 기타 중대한 사유로 인하여 “회사”가 “서비스” 제공을 지속하는 것이
                    부적당하다고 인정하는 경우
                  </P>
                </li>
              </OL>
        ...
        <Article>
          ...
          <P>
            “회원”과 “파트너스”의 상호간 거래 행위에 발생하는 분쟁은 당사자 협의를 원칙으로 합니다.
            다만, 당사자 간 협의가 이루어지지 않을 경우 한국소비자원에 구제신청을 할 수 있습니다.
          </P>
        </Article>
        <Article>
          <H2>제16조 (면책)</H2>
          <OL>
            <li>
              <P>
                ...
                경우에는 고의 또는 과실이 없는 한 “회원”’에게 발생한 손해에 대하여 서비스 제공에
                관한 책임이 면제됩니다.
              </P>
              <P>
              ...
              <P>
                3. “회사”는 “회원”과 “파트너스” 간 재화 또는 용역 등의 거래를 중개하는 플랫폼
                서비스만을 제공할 뿐, 재화 등을 판매하는 당사자가 아니며, “회원”과 “파트너스” 간에
                분쟁이 발생했을 경우 고의 또는 중과실이 없는 한 법적 문제에 대하여 책임을 지지
                않습니다.
              </P>
              <P>
        ...
        <Article>
          ...
          <OL>
            <li>
              ...
              <P>[부칙] 본 약관은 2022년 11월 30일부터 적용됩니다.</P>
            </li>
          </OL>
        </Article>
      </ContentContainer>
